...
- [ ] Validate extension declarations and ensure Level 1 success never depends on a vendor extension.
- [ ] Store adapter plan, result, and evidence files as CI artifacts.
...
- [ ] Keep unit/profile tests, API profile conformance, wire E2E, vLLM contract matrix, and GPU smoke
  as separate CI jobs.
- [ ] Run normal CI without importing vLLM or requiring a GPU.
