...
- [ ] Track `OBJECT_DECLARE`, `OBJECT_REF`, `OBJECT_RELEASE`, `OBJECT_PATCH`, and `OBJECT_DELTA` by
...
- [ ] Keep cache policy opt-in and explicit; do not perform implicit lookups.
...
- [ ] Keep NNRP object/cache identity separate from vLLM KV-cache internals.
