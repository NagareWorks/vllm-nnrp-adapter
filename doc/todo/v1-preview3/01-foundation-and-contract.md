...
- [x] Add repository-scoped conformance capability metadata once the adapter runner command is implemented.
- [x] Add profile compatibility fixtures that mirror the shared conformance recipe names.
