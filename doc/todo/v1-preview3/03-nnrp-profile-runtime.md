...
- [ ] Add an embedded vLLM-process NNRP session loop for submit/result-push without an intermediate HTTP request.
- [ ] Preserve frame ownership, trace id, route id, and view id through the embedded vLLM request lifecycle.
